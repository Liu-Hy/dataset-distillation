...
if __name__ == '__main__':
    #sigma = get_noise_multiplier(target_epsilon=1.0, target_delta=1e-5, sample_rate=1280/50000, steps=200000)
    sigma = get_noise_multiplier(target_epsilon=10.0, target_delta=1e-5, sample_rate=1280/50000, steps=10000)
    print(sigma)